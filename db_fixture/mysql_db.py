...
class DB:
    ...
    def update_mock_condition(self, condition, mockdetailid):
        real_sql = "update httpmock_condition set mockCondition='{}' where mock_detailId='{}';".format(condition, mockdetailid)
        with self.connection.cursor() as cursor:
            cursor.execute(real_sql)
        self.connection.commit()
