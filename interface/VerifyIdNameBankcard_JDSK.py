...
# @Author : hemq
# @File : verify_id_name_bankcard_--银行卡四要素对接-京东数科
# @Software: PyCharm
...
class verify_id_name_bankcard_jdsk(unittest.TestCase):
    '''verify_id_name_bankcard--银行三四要素对接-京东数科'''

    @classmethod
    def setUpClass(cls):
        # cls.__url = "https://cloudapi.linkface.cn//data/verify_id_name_bankcard" # 线上地址
        # cls.__url = "http://cloudapijavastage.linkface.cn/data/verify_id_name_bankcard"  # 灰度地址
        cls.__url = "http://100.73.18.123:19641/data/verify_id_name_bankcard"  # 测试地址
        cls.__wrongurl = "http://cloudapijavastage.linkface.cn//data/verify_id_name_bankcar"  # 错误地址
    ...
    def test_36_idNumberIncludeNum(self):
        ''' id_number 字段值传num'''
        self.__data['id_number'] = 360429199506120315
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
