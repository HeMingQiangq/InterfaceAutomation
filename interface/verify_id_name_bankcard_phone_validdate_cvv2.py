#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# @Time : 2019/07/03 上午11:03
# @Author : hemq
# @File : verify_id_name_bankcard_phone_validdate_cvv2--银行卡六要素对接-吉信
# @Software: PyCharm
...
class Verifyidnamebankcardphonevaliddatecvv(unittest.TestCase):
    '''verify_id_name_bankcard_phone_validdate_cvv2--银行卡六要素对接-吉信'''

    @classmethod
    def setUpClass(cls):
        # cls.__url = "https://cloudapi.linkface.cn//data/verify_id_name_bankcard_phone_validdate_cvv2" # 线上地址
        cls.__url = "http://cloudapijavastage.linkface.cn/data/verify_id_name_bankcard_phone_validdate_cvv2" # 灰度地址
        # cls.__url = "http://100.73.18.118:19641/data/verify_id_name_bankcard_phone_validdate_cvv2"  # 测试地址
        cls.__wrongurl = "http://cloudapijavastage.linkface.cn//data/verify_id_name_bankcard_phone_validdate_cv"  # 错误地址
    ...
    def test_35_idNumberIncludeNum(self):
        ''' id_number 字段值传num'''
        self.__data['id_number'] = 370686199109231716
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
    ...
    def test_36_idNumberIncludeTrue(self):
        ''' id_number 字段值传true'''
    ...
    def test_37_idNumberIncludeFalse(self):
        ''' id_number 字段值传false'''
    ...
    def test_37_idNumberIncludeEtter(self):
        ''' id_number 字段值传字母'''
    ...
    def test_38_cardNumbermpty(self):
        ''' cardNumber 参数值为空'''
    ...
    def test_39_cardNumberDeletion(self):
        ''' cardNumber 字段不传'''
    ...
    def test_40_cardNumberIncludeEtter(self):
        ''' cardNumber 字段包含字母'''
    ...
    def test_41_cardNumberIncludeBlank(self):
        ''' cardNumber 字段包含空格'''
    ...
    def test_42_cardNumberIncludeSpecialharacter(self):
        ''' cardNumber 字段包含特殊字符'''
        self.__data['card_number'] = '#$%,;'
        client = self.client
        client.set_data(self.__data)
    ...
    def test_43_cardNumberIncludeEtterAndBlank(self):
    ...
    def test_44_cardNumberIncludeEtterAndSpecialharacter(self):
    ...
    def test_45_cardNumberIncludeBlankAndSpecialharacter(self):
    ...
    def test_46_phoneNumbermpty(self):
        ''' phoneNumber 参数值为空'''
    ...
    def test_47_phoneNumberDeletion(self):
        ''' phoneNumber 字段不传'''
    ...
    def test_48_phoneNumberMax(self):
        ''' phoneNumber 长度超过11位'''
    ...
    def test_49_phoneNumberMax(self):
    ...
    def test_50_phoneNumberIncludeEtter(self):
        ''' phoneNumber 字段包含字母'''
    ...
    def test_51_phoneNumberIncludeBlank(self):
        ''' phoneNumber 字段包含空格'''
        self.__data['phone_number'] = '        '
        client = self.client
        client.set_data(self.__data)
    ...
    def test_52_phoneNumberIncludeSpecialharacter(self):
    ...
    def test_53_phoneNumberIncludeEtterAndBlank(self):
    ...
    def test_54_phoneNumberIncludeEtterAndSpecialharacter(self):
    ...
    def test_55_phoneNumberIncludeBlankAndSpecialharacter(self):
    ...
    def test_56_valid_datempty(self):
        ''' valid_date 参数值为空'''
        self.__data['valid_date'] = ''
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
        ...
        client.check_dict_equal({
            "status": "INVALID_ARGUMENT",
            "reason": "argument 'valid_date': blank string",
            "request_id": "request_id"
        })

    def test_57_valid_dateDeletion(self):
        ''' valid_date 字段不传'''
        del (self.__data['valid_date'])
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
        ...
        client.check_dict_equal({
            "status": "INVALID_ARGUMENT",
            "reason": "argument 'valid_date': not found",
            "request_id": "request_id"
        })

    def test_58_valid_dateIncludeEtter(self):
        ''' valid_date 字段包含字母'''
        self.__data['valid_date'] = 'xbshbxhsbxhsbxhs'
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
        ...
        client.check_dict_equal({
            "status": "INVALID_ARGUMENT",
            "reason": "Invalid valid_date",
            "request_id": "request_id"
        })

    def test_59_valid_dateIncludeBlank(self):
        ''' valid_date 字段包含空格'''
        self.__data['valid_date'] = '        '
        client = self.client
        client.set_data(self.__data)
    ...
    def test_60_valid_dateIncludeSpecialharacter(self):
        ''' valid_date 字段包含特殊字符'''
        self.__data['valid_date'] = '#$%,;'
        client = self.client
        client.set_data(self.__data)
    ...
    def test_61_valid_dateIncludeEtterAndBlank(self):
        ''' valid_date 字段包含字母+空格'''
        self.__data['valid_date'] = 'sss cdcd'
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
    ...
    def test_62_valid_dateIncludeEtterAndSpecialharacter(self):
        ''' valid_date 字段包含字母+特殊字符'''
        self.__data['valid_date'] = 'xsxs#￥%……&*'
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
    ...
    def test_63_valid_dateIncludeBlankAndSpecialharacter(self):
        ''' valid_date 字段包含空格+特殊字符'''
        self.__data['valid_date'] = '   ￥%……&*'
        client = self.client
        client.set_data(self.__data)
        client.send()
    ...
    def test_64_cvv2mpty(self):
        ...
        client.check_dict_equal({
            "status": "INVALID_ARGUMENT",
            "reason": "argument 'cvv2': blank string",
            "request_id": "request_id"
        })

    def test_65_cvv2Deletion(self):
        ''' cvv2 字段不传'''
        del (self.__data['cvv2'])
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
        ...
        client.check_dict_equal({
            "status": "INVALID_ARGUMENT",
            "reason": "argument 'cvv2': not found",
            "request_id": "request_id"
        })

    def test_66_cvv2IncludeEtter(self):
        ''' cvv2 字段包含字母'''
        self.__data['cvv2'] = 'xbshbxhsbxhsbxhs'
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
    ...
    def test_67_cvv2IncludeBlank(self):
        ''' cvv2 字段包含空格'''
        self.__data['cvv2'] = '        '
        client = self.client
        client.set_data(self.__data)
    ...
    def test_68_cvv2IncludeSpecialharacter(self):
        ''' cvv2 字段包含特殊字符'''
        self.__data['cvv2'] = '#$%,;'
        client = self.client
        client.set_data(self.__data)
    ...
    def test_69_cvv2IncludeEtterAndBlank(self):
        ''' cvv2 字段包含字母+空格'''
        self.__data['cvv2'] = 'sss cdcd'
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
    ...
    def test_70_cvv2IncludeEtterAndSpecialharacter(self):
        ''' cvv2 字段包含字母+特殊字符'''
        self.__data['cvv2'] = 'xsxs#￥%……&*'
        client = self.client
        client.set_data(self.__data)
        client.send()
        client.write_to_csv(self.__path)
    ...
    def test_71_cvv2IncludeBlankAndSpecialharacter(self):
        ''' cvv2 字段包含空格+特殊字符'''
        self.__data['cvv2'] = '   ￥%……&*'
        client = self.client
        client.set_data(self.__data)
